                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <div class="dt-sc-single-room-price">
                    	<div class="hotel-price">
                        	<span><?php echo dt_theme_currecy_symbol(); ?><?php echo $room_meta['room_price']; ?></span><?php _e('Per Night' ,'dt_themes'); ?>
                    ...
                    <div class="dt-single-room-wrapper">
                        ...
                        <ul class="dt-single-room-meta">
                            <li><span><?php _e('Occupancy', 'dt_themes'); ?></span> <?php echo $room_meta['room_occupancy']; ?></li>
                            <li><span><?php _e('Room Size', 'dt_themes'); ?></span> <?php echo $room_meta['room_size']; ?></li>
                        </ul>
					</div>
                </article>
