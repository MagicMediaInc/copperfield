<?php get_header();
	...
	while(have_posts()): the_post();
	  ...
	  //GETTING META VALUES...
	  $meta_set = get_post_meta($post->ID, '_agent_settings', true);
	  $page_layout = !empty($meta_set['layout']) ? $meta_set['layout'] : 'single-agent-layout-one';
      ...
      <div id="main">
		<section id="primary" class="content-full-width">
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class('fullwidth-section'); ?>>
				<div class="container">
                    <div class="portfolio-single"><?php
						...
						if($page_layout == "single-agent-layout-one"):
							include(dirname(__FILE__).'/inc/agent-single-layout-one.php');
						else:
							include(dirname(__FILE__).'/inc/agent-single-layout-two.php');
						endif; ?>
						...
						<?php if(dt_theme_option('general', 'disable-agent-comment') != true && (isset($p_meta_set['comment']) != "")) { 
			...
			if(isset($meta_set['show-related-items']) != ""):
				...
				$args = array('orderby' =>	'rand', 'post_type' => 'dt_agents', 'post__not_in' => array(get_the_ID()), 'posts_per_page' => 8);
				...
				if($the_query->have_posts()): ?>
                    <div class="fullwidth-section">
						...
						$terms = wp_get_post_terms($post->ID, 'agent_entries', array("fields" => "slugs")); array_walk($terms, "arr_strfun"); ?>
                            ...
                            <div class="portfolio dt-sc-one-fourth column no-space <?php strtolower(implode(" ", $terms)); ?>">
                                <figure><?php
									...
									$currenticon = "fa-plus";
									$pmeta_set = get_post_meta($post->ID, '_agent_settings', true);
									...
									<figcaption>
                                      <div class="fig-content-wrapper">
										<div class="fig-content">
											...
											<p><?php echo get_the_term_list($post->ID, 'agent_entries', ' ', ', ', ' '); ?></p>                                            
											<div class="fig-overlay">
											  <a class="zoom" title="<?php the_title(); ?>" data-gal="prettyPhoto[agent]" href="<?php echo $currenturl; ?>"><span class="fa <?php echo $currenticon; ?>"> </span></a>
