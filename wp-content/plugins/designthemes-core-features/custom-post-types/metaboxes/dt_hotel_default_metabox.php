...
$agents = get_posts( array( 'post_type' => 'dt_agents'));
?>
...
<div class="custom-box">
    ...
    <div class="column five-sixth last">
        <?php $agnt = array_key_exists("agent",$hotel_settings) ?  $hotel_settings['agent'] : '';?>
        <select class="chosen" required name="agent">
            <option> Seleccione un agente </option>
            <?php
            foreach($agents as $agent):
                if($agnt == $agent->ID):
                ?>
                <option value="<?php echo $agent->ID; ?>" selected><?php echo $agent->post_title; ?></option>
                <?php
                else:
                ?>
                <option value="<?php echo $agent->ID; ?>"><?php echo $agent->post_title; ?></option>
                <?php
                endif;
            endforeach;
            ?>
