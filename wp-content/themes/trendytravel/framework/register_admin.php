...
function dt_theme_admin_panel_scripts() {
	...
	if($current_screen->base == 'dt_hotels_page_availablesettings') {
		wp_enqueue_style('hb-flick-theme', get_template_directory_uri().'/framework/hotelbooking/css/flick/jquery-ui.min.css');
		wp_enqueue_style('hb-flick-ui-dp', get_template_directory_uri().'/framework/hotelbooking/css/ui-flick.datepick.css');

		wp_enqueue_script('jquery-ui');
		wp_enqueue_script('jquery-ui-datepicker');

		wp_enqueue_script('hb-multipicker', get_template_directory_uri().'/framework/hotelbooking/js/jquery-ui.multidatespicker.js', array(), false, true);
	}
	if($current_screen->base == 'dt_hotels_page_servicesettings' || $current_screen->base == 'dt_hotels_page_ordersettings') {
		wp_enqueue_style('hb-table-pager', get_template_directory_uri().'/framework/hotelbooking/css/themes/blue/style.css');

		wp_enqueue_script('hb-table-sorter', get_template_directory_uri().'/framework/hotelbooking/js/jquery.tablesorter.min.js');
		wp_enqueue_script('hb-table-pager', get_template_directory_uri().'/framework/hotelbooking/js/jquery.tablesorter.pager.js');
		wp_enqueue_script('hb-quick-search', get_template_directory_uri().'/framework/hotelbooking/js/jquery.quicksearch.js');
	}

	wp_enqueue_style('hb-custom', get_template_directory_uri().'/framework/hotelbooking/css/style.css');
	
	wp_enqueue_script('hb-admin-js', get_template_directory_uri().'/framework/hotelbooking/js/hotel_scripts.js', array('jquery'));
