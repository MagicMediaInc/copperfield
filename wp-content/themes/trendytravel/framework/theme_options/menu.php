...
require_once(get_template_directory().'/framework/hotelbooking/generalsettings.php');
require_once(get_template_directory().'/framework/hotelbooking/availablesettings.php');
require_once(get_template_directory().'/framework/hotelbooking/servicesettings.php');
require_once(get_template_directory().'/framework/hotelbooking/ordersettings.php');

require_once(get_template_directory().'/framework/hotelbooking/admin/core-functions.php');
require_once(get_template_directory().'/framework/hotelbooking/frontend-functions.php');
