...
function dt_theme_enqueue_styles() {
	...
	wp_enqueue_style('hb-front-flick-theme', get_template_directory_uri().'/framework/hotelbooking/css/flick/jquery-ui.min.css');
	wp_enqueue_style('hb-front-flick-ui-dp', get_template_directory_uri().'/framework/hotelbooking/css/ui-flick.datepick.css');
