                          ...
                          <form id="frmhotelcheckout" name="frmhotelcheckout" action="<?php the_permalink(); ?>" method="post">
                              <div class="dt-sc-one-third column first dt-reserve-wrapper">
                                  ...
                                  <ul>
                                      ...
                                      $total_days = count(dt_theme_get_all_dates($_COOKIE['checkin'], $_COOKIE['checkout'])); $room_meta = get_post_meta($_REQUEST['room_id'], '_room_settings', true); $rcost = $room_meta['room_price']; ?>
                                      ...
                                      if($service_opts != NULL):
                                          foreach($service_opts as $key => $service):
                                              if($service['hb-hotel-id'] == $_REQUEST['hotel_id']):
                                                  ?><li><input type="checkbox" value="<?php echo $key; ?>" name="chkservice[]" /><?php echo $service['hb-service-name'].' ('.dt_theme_currecy_symbol().$service['hb-service-price'].')'; ?></li><?php					endif;					
                                          endforeach;
                                      endif;	
                                  ?>
                                  </ul>
                                  ...
                                  <ul class="dt-net-wrapper"><?php
									  ...
									  if($hb_general_settings['hb-general-enabledepositdue'] && $hb_general_settings['hb-general-depositpercent'] != ""):
									     $depPercent = $hb_general_settings['hb-general-depositpercent']; ?>
