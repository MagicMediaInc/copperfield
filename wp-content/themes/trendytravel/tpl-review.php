              ...
              <?php endif; ?>
				  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>><?php
					  ...
					  if(isset($_COOKIE['checkin']) != "" && isset($_COOKIE['checkout']) != "" && $_REQUEST['token']): ?>
                      	  <div class="dt-sc-success-reserve"><i class="fa fa-user"></i>Hi! You have successfully made a reservation. Here are your reservation details.</div>
					  ...
					  elseif(isset($_REQUEST['payarrival']) == 'true'): ?>
                      	  <div class="dt-sc-success-reserve"><i class="fa fa-user"></i><strong>Hi <?php echo $_REQUEST['fname']; ?>!</strong> You have successfully made a reservation. Here are your reservation details.</div>
                      	  <h3 class="section-title aligncenter"><?php _e('Your Order Confirmation', 'iamd_text_domain'); ?></h3>
						  <table>
