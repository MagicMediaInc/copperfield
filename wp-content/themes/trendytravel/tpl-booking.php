          ...
          <div class="container">
              ...
              <?php endif; ?>
				  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>><?php
                      ...
                      <form id="frmbooking" name="frmbooking" action="<?php echo $action; ?>" method="post">
                          <label for="txtcheckindate"><?php _e('Checkin Date', 'iamd_text_domain'); ?><span>*</span></label>
                          <input type="text" class="datepicker" name="txtcheckindate" id="txtcheckindate" readonly="readonly" value="<?php echo !empty($_REQUEST['txtckindate']) ? $_REQUEST['txtckindate'] : '';?>" />
                          
                          <label for="txtcheckoutdate"><?php _e('Checkout Date', 'iamd_text_domain'); ?><span>*</span></label>
                          <input type="text" class="datepicker" name="txtcheckoutdate" id="txtcheckoutdate" readonly="readonly" value="<?php echo !empty($_REQUEST['txtckoutdate']) ? $_REQUEST['txtckoutdate'] : ''; ?>" />
